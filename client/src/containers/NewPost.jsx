...
import { NewPostBackground } from "../assets";
  ...
  return (
    <div className="w-screen h-auto flex flex-col items-center justify-center relative">
      <div className=" w-full  h-340 relative">
        <img src={NewPostBackground} className="w-full h-full object-cover" alt="" />
            ...
            {subMenu &&
              subMenu.map((menu) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? "text-base md:text-lg text-blue-400 hover:text-blue-400  cursor-pointer"
                      : "text-base md:text-lg text-primary hover:text-blue-400  cursor-pointer"
                  }
                  to={menu.slug}
                >
                  {menu.name}
