        ...
        {user ? (
          <>
            <div className="relative cursor-pointer">
              ...
              {/* user menu options */}
              {isMenu && (
                <div className="absolute right-0 top-12 rounded-md shadow-md w-64 px-4 py-3 bg-[#191B26] flex flex-col items-start justify-center gap-3" onMouseLeave={() => setIsMenu(false)}>
          ...
          <>
            ...
            >
              <FcGoogle />
              <p className={`${color ? "text-primary" : "text-gray-200"}`}>
                Login
              </p>
            </div>
          </>
